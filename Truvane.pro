...
unrealRootPath=/home/fatherbad/Game/UnrealEngine
TruvaneRootPath=/home/fatherbad/Game/Projects/Truvane

gameProjectFile=/home/fatherbad/Game/Projects/Truvane/Truvane.uproject
build=mono $$unrealRootPath/Engine/Binaries/DotNET/UnrealBuildTool.exe

args=$(ARGS)

include(TruvaneSource.pri)
include(TruvaneHeader.pri)
include(TruvaneConfig.pri)
include(TruvaneIncludes.pri)
include(TruvaneDefines.pri)
...
Truvane-Linux-Debug.commands = $$build Truvane Linux Debug  -project="\"$$gameProjectFile\"" $$args
Truvane-Linux-DebugGame.commands = $$build Truvane Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
Truvane-Linux-Shipping.commands = $$build Truvane Linux Shipping  -project="\"$$gameProjectFile\"" $$args
Truvane-Linux-Test.commands = $$build Truvane Linux Test  -project="\"$$gameProjectFile\"" $$args
Truvane.commands = $$build Truvane Linux Development  -project="\"$$gameProjectFile\"" $$args

TruvaneEditor-Linux-Debug.commands = $$build TruvaneEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
TruvaneEditor-Linux-DebugGame.commands = $$build TruvaneEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
TruvaneEditor-Linux-Shipping.commands = $$build TruvaneEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
TruvaneEditor-Linux-Test.commands = $$build TruvaneEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
TruvaneEditor.commands = $$build TruvaneEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	Truvane-Linux-Debug \
	Truvane-Linux-DebugGame \
	Truvane-Linux-Shipping \
	Truvane-Linux-Test \
	Truvane \
	TruvaneEditor-Linux-Debug \
	TruvaneEditor-Linux-DebugGame \
	TruvaneEditor-Linux-Shipping \
	TruvaneEditor-Linux-Test \
	TruvaneEditor \
