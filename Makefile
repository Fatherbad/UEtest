...
Truvane-Linux-Debug:
	 $(PROJECTBUILD) Truvane Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

Truvane-Linux-DebugGame:
	 $(PROJECTBUILD) Truvane Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

Truvane-Linux-Shipping:
	 $(PROJECTBUILD) Truvane Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

Truvane-Linux-Test:
	 $(PROJECTBUILD) Truvane Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

Truvane:
	 $(PROJECTBUILD) Truvane Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

TruvaneEditor-Linux-Debug:
	 $(PROJECTBUILD) TruvaneEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

TruvaneEditor-Linux-DebugGame:
	 $(PROJECTBUILD) TruvaneEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

TruvaneEditor-Linux-Shipping:
	 $(PROJECTBUILD) TruvaneEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

TruvaneEditor-Linux-Test:
	 $(PROJECTBUILD) TruvaneEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

TruvaneEditor:
	 $(PROJECTBUILD) TruvaneEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
